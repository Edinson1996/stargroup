...
function(t)
{
	...
	}), t(".instafeed-wrapper").each(function()
	{
		...
		null != i && a.html(""), t.ajax(
		{
			...
			success: function(e)
			{
				for (var s in r += a.find(".grid-item").length > 0 ? '<li class="grid-sizer"></li>' : "", e.data) if (s < parseInt(o) && "IMAGE" == e.data[s].media_type)
				{
	...
	{
		var a = t(this);
		a.addClass("open"), a.siblings(".dropdown").removeClass("open"), z() > i && (!
		function(e)
		{
			var t = z();
