        ...
        <div class="card login-card">
            <div class="row no-gutters">
                <div class="col-md-5 p-3 p-md-5" style="vertical-align: middle">
                    <img src="{{asset('admin/assets/img/logo.png')}}" alt="login" class="" width="100%">
                </div>
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text"
                                       name="email" value="{{ old('email') }}" required autofocus class="form-control @error('email') is-invalid @enderror" placeholder="Usuario">
                                @error('email')
